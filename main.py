...
##---------------------------------------------------------------------------##
  ...
  if calc == 'ICCSD':
    ...
    R_ijab += amplitude.singles_n_doubles(t1,I_oovo,I_vovv) 
    #R_ijab += amplitude.higher_order(t1,t2,Iovov_3,Iovvo_3,Iooov,I3,Ioooo_2,I_voov)
    #R_ia += amplitude.inserted_diag_So_t1(t1,II_oo) 
    #R_ia += amplitude.inserted_diag_Sv_t1(t1,II_vv) 
    ...
    #R_iuab += amplitude.nonlinear_Sv(II_vv,Sv)
    ...
    #R_ijav += amplitude.nonlinear_So(II_oo,So)
