...
##-------------Linear terms of both R_ia and R_ijab--------------##
  Y_ia = amplitude.singles_response_linear(I_oo,I_vv,dict_t1[r],dict_t2[r])
  Y_ijab = amplitude.doubles_response_linear(I_oo,I_vv,Ivvvv,Ioooo,Iovvo,Iovvo_2,Iovov,Iovov_2,dict_t1[r],dict_t2[r])
##---------------------------------------------------------------##
...
##-----------------------------------------------------------------##
##--------------one body diagrams---------------------------------##
  Y_ia += amplitude.singles_response_quadratic(I_oo,I_vv,I1,I2,dict_t1[r],dict_t2[r])
  Y_ia += amplitude.singles_response_quadratic(I_oo_new,I_vv_new,I1_new,I2_new,t1,t2)
...
##------------------------------------------------------------##
##-----------------Two body diagrams--------------------------##
  Y_ijab += amplitude.doubles_response_quadratic(I_oo,I_vv,Ioooo,Iovvo,Iovvo_2,Iovov,dict_t2[r]) 
  Y_ijab += amplitude.doubles_response_quadratic(I_oo_new,I_vv_new,Ioooo_new,Iovvo_new,Iovvo_2_new,Iovov_new,t2) 
  Y_ijab += amplitude.singles_n_doubles_response(dict_t1[r],I_oovo,I_vovv)
  Y_ijab += amplitude.singles_n_doubles_response(t1,I_oovo_new,I_vovv_new)
  ...
  Y_ijab += amplitude.inserted_diag_Sv(t2,II_vv)
  Y_ijab = cc_symmetrize.symmetrize(Y_ijab)
##------------------------------------------------------------##
##----------Diagram contributing to R_ijav and R_iuab------------## 
  Y_iuab = amplitude.Sv_diagram_vs_contraction(dict_Sv[r],II_vv)
  Y_iuab += amplitude.Sv_diagram_vt_contraction(dict_t2[r])
  Y_ijav = amplitude.So_diagram_vs_contraction(dict_So[r],II_oo)
