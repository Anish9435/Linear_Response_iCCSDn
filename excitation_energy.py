...
def calc_excitation_energy(isym, nroot):
  ...
  #dict_t1,dict_t2,dict_So,dict_Sv = davidson.guess_X(occ,virt,o_act,v_act,nroot)
  ...
  ##------------------------------------------------------------------##
    ...
    if (sum(count)== nroot):
      for iroot in range(0,nroot):
        print "!!!!!!!!!!CONVERGED!!!!!!!!!!!!"
        print 'Excitation Energy for sym', isym, 'iroot', iroot, ' :', w[iroot], ' a.u. ', w[iroot]*27.2113839, ' eV'
      break
